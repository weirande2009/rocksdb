...
struct Result {
    int64_t min_overlapping_ratio_wa;
    int64_t select_last_similar_wa;
    double max_mor_distance;
    int64_t min_overlapping_ratio_median;
    int64_t min_overlapping_ratio_stddev;
    int64_t select_last_similar_median;
    int64_t select_last_similar_stddev;
    size_t mor_compaction_times;
    size_t om_compaction_times;
    int64_t mor_duration;
    int64_t om_duration;
    int mor_similar_compaction_times = 0;
    int om_similar_compaction_times = 0;
    int om_same_choice_times = 0;
    double distance;
};
