...
initialize_workspace experiment
time run_all_baselines $total_bytes mnt/rocksdb/ experiment workloads/1.txt $write_buffer_size $target_file_size_base $target_file_number
