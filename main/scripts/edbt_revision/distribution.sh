...
uniform_distribution() {
    ...
    # no distribution
    rocksdb_root_dir=/scratchNVM1/ranw/uniform
    run_multiple_times_for_baseline 100 0 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 90 10 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 80 20 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 70 30 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 60 40 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &

    wait $(jobs -p)

    run_multiple_times_for_baseline 50 50 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 40 60 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 30 70 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 20 80 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
    run_multiple_times_for_baseline 10 90 0 $num_workloads $rocksdb_root_dir --ID\ 0 uniform &
