...
run_multiple_times_for_baseline() {
    ...
    dir_name=edbt_revision/compare_devices/5gb/third_run/${percentage_insert}_${percentage_update}
    ...
    rocksdb_dir_nvme1=/scratchNVM1/ranw/nvme1/$dir_name
    rocksdb_dir_ssd=/scratchSSD/ranw/ssd/$dir_name
