...
run_multiple_times_for_baseline() {
    ...
    dir_name=compare_workload_size/refinedmor-1/$7/${percentage_insert}_${percentage_update}
...
run_multiple_times_for_baseline 25 75 $num_workloads $rocksdb_root_dir $num_operation $entry_size $experiment_name &
