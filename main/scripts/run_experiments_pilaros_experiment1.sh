...
run_multiple_times_for_a_type() {
    ...
    experiment_name=${num_insert}_${num_update}_0_${entry_size}_8_memory/first_run/${percentage_insert}_${percentage_update}
...
run_multiple_times_for_a_type 80 20 $num_workloads & # workload 3: 80% insert, 20% update
run_multiple_times_for_a_type 70 30 $num_workloads & # workload 4: 70% insert, 30% update
run_multiple_times_for_a_type 60 40 $num_workloads & # workload 5: 60% insert, 40% update
run_multiple_times_for_a_type 50 50 $num_workloads   # workload 6: 50% insert, 50% update
