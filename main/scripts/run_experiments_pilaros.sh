...
echo 'memory test'
time ./run_once_existing.sh mnt/rocksdb/ experiment_memory kMinOverlappingRatio $total_bytes $workload_dir/1.txt
echo 'nvm test'
time ./run_once_existing.sh mnt/rocksdb/ experiment_nvm kMinOverlappingRatio $total_bytes $workload_dir/1.txt
