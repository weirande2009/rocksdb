...
workload_dir_test_skip=workloads/consistency_checking/2000000_0_0_64_8_memory/complete_test_concurrent_3_non_skip
...
./scripts/run_for_a_type.sh $enumeration_runs /mnt/ramd/ranw/rocksdb1/ $workspace_dir_non_skip/run1 $workload_dir_test_skip/type1.txt $total_bytes 0 &
./scripts/run_for_a_type.sh $enumeration_runs /mnt/ramd/ranw/rocksdb2/ $workspace_dir_non_skip/run2 $workload_dir_test_skip/type2.txt $total_bytes 0 &
./scripts/run_for_a_type.sh $enumeration_runs /mnt/ramd/ranw/rocksdb3/ $workspace_dir_non_skip/run3 $workload_dir_test_skip/type3.txt $total_bytes 0 &

./scripts/run_for_a_type.sh $enumeration_runs /mnt/ramd/ranw/rocksdb4/ $workspace_dir_skip/run1 $workload_dir_test_skip/type1.txt $total_bytes 1 &
./scripts/run_for_a_type.sh $enumeration_runs /mnt/ramd/ranw/rocksdb5/ $workspace_dir_skip/run2 $workload_dir_test_skip/type2.txt $total_bytes 1 &
./scripts/run_for_a_type.sh $enumeration_runs /mnt/ramd/ranw/rocksdb6/ $workspace_dir_skip/run3 $workload_dir_test_skip/type3.txt $total_bytes 1 &
