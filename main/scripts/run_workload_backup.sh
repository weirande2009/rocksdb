...
run_once() {
    ...
    ./simple_example $4 $1 $2 $3 $5 0 0 $6 $7 $8 $9
    cp $2/LOG $3/LOG
}
...
run_all_baselines() {
    ...
    find $2 -mindepth 1 -delete
    ./simple_example_backup kRoundRobin $1 $2 $3 $4 0 0 $5 $6 $7 $8 $9
    cp $2/LOG $3/LOG_RR
    rocksdb_size=$(du -sk $2 | awk '{ printf "%dK\n", $1 }')
    echo "kRoundRobin: $rocksdb_size" >> $3/rocksdb_size.txt

    find $2 -mindepth 1 -delete
    ./simple_example_backup kMinOverlappingRatio $1 $2 $3 $4 0 0 $5 $6 $7 $8 $9
    cp $2/LOG $3/LOG_MOR
    rocksdb_size=$(du -sk $2 | awk '{ printf "%dK\n", $1 }')
    echo "kMinOverlappingRatio: $rocksdb_size" >> $3/rocksdb_size.txt

    find $2 -mindepth 1 -delete
    ./simple_example_backup kOldestLargestSeqFirst $1 $2 $3 $4 0 0 $5 $6 $7 $8 $9
    cp $2/LOG $3/LOG_OLSF
    rocksdb_size=$(du -sk $2 | awk '{ printf "%dK\n", $1 }')
    echo "kOldestLargestSeqFirst: $rocksdb_size" >> $3/rocksdb_size.txt

    find $2 -mindepth 1 -delete
    ./simple_example_backup kOldestSmallestSeqFirst $1 $2 $3 $4 0 0 $5 $6 $7 $8 $9
    cp $2/LOG $3/LOG_OSSF
    rocksdb_size=$(du -sk $2 | awk '{ printf "%dK\n", $1 }')
