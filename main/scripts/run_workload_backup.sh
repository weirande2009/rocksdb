...
run_once() {
    ...
    ./simple_example_backup $4 $1 $2 $3 $5 0 0 $6 $7 $8
}
...
run_baseline() {
    ...
    find $2 -mindepth 1 -delete
    ./simple_example_backup kRoundRobin $1 $2 $3 $4 0 0 $5 $6 $7

    find $2 -mindepth 1 -delete
    ./simple_example_backup kMinOverlappingRatio $1 $2 $3 $4 0 0 $5 $6 $7
}
...
run_all_baselines() {
    ...
    find $2 -mindepth 1 -delete
    ./simple_example_backup kOldestLargestSeqFirst $1 $2 $3 $4 0 0 $5 $6 $7

    find $2 -mindepth 1 -delete
    ./simple_example_backup kOldestSmallestSeqFirst $1 $2 $3 $4 0 0 $5 $6 $7
}
