...
run_multiple_times_for_baseline() {
    ...
    dir_name=compare_workload_size/third_run/$7/${percentage_insert}_${percentage_update}
    ...
    do  
        ...
        time run_all_baselines_2 $workload_size $rocksdb_dir $workspace_dir/run$i $workload_dir/${i}.txt $write_buffer_size $target_file_size_base $target_file_number Vector
