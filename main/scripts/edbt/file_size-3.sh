...
run_multiple_times_for_baseline() {
    ...
    do  
        ...
        run_once $workload_size $rocksdb_dir $workspace_dir/run$i kRoundRobin $workload_dir/${i}.txt $write_buffer_size $target_file_size_base $max_bytes_for_level_base Vector $max_bytes_for_level_multiplier
        run_once $workload_size $rocksdb_dir $workspace_dir/run$i kMinOverlappingRatio $workload_dir/${i}.txt $write_buffer_size $target_file_size_base $max_bytes_for_level_base Vector $max_bytes_for_level_multiplier
